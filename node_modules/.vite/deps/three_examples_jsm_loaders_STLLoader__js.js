import { Bs as Vector3, J as BufferGeometry, To as SRGBColorSpace, Ur as Loader, bn as Float32BufferAttribute, q as BufferAttribute, st as Color, vn as FileLoader } from "./three.module-WUaEXHqA.js";
	...
	*/
	parse(data) {
		function isBinary(data) {
			...
			if (84 + reader.getUint32(80, true) * 50 === reader.byteLength) return true;
			const solid = [
				115,
				111,
				108,
		...
		function matchDataViewAt(query, reader, offset) {
			for (let i = 0, il = query.length; i < il; i++) if (query[i] !== reader.getUint8(offset + i)) return false;
			return true;
		}
		...
		function ensureBinary(buffer) {
			if (typeof buffer === "string") {
				...
				for (let i = 0; i < buffer.length; i++) array_buffer[i] = buffer.charCodeAt(i) & 255;
